        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              A refreshing scoop crafted using real lychee fruit,
              offering a naturally sweet and smooth texture.
              Made with fresh ingredients, it delivers a light,
              juicy experience that feels cool and refreshing
              with every bite.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Prepared with real mango pulp sourced from natural fruits,
              this creamy scoop delivers a rich and smooth texture.
              The sweetness of fresh mango creates a vibrant and
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Made using fresh coconut and natural ingredients,
              this scoop offers a silky smooth texture and refreshing
              taste. The gentle sweetness of coconut creates a relaxing
              tropical dessert experience.
            </p>
          </div>
      ...
      <div className="py-16 px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Every scoop is crafted using high‑quality fresh ingredients
              to ensure the richest flavors and the creamiest texture.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Personalize your ice cream with a wide range of toppings
              including chocolate chips, caramel drizzle, nuts and more.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Scoopify offers a smooth and fast ordering experience
              so you can get your favorite ice creams without any hassle.
            </p>
          </div>
